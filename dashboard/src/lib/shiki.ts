  ...
  tokenColors: [
    {
      ...
      settings: { foreground: "#6b6760", fontStyle: "italic" },
    },
    ...
    { scope: ["constant.numeric", "constant.language"], settings: { foreground: "#d4a04a" } },
    {
      ...
      settings: { foreground: "#928466", fontStyle: "italic" },
    },
    ...
    { scope: ["punctuation", "meta.brace"], settings: { foreground: "#6b6760" } },
    {
      ...
      settings: { foreground: "#b8a67f", fontStyle: "bold" },
    },
